 ...
 * Used on both the Host and the Guest to display the map, info, and such in the game.
 */
...
public:
    ...
    /**
     * Used to pass a HostNetworkHandler along to the gameDialog to make the appropriate connection
     */
